...
class WxPayConf_pub
{
	...
	const APPID = 'wxc1234FGFHGDSF';
	//受理商ID，身份标识
	const MCHID = '1246789012';
	//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
	const KEY = 'adbhgy687678fdg;34576';
	//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
	const APPSECRET = '14dgkffkv787kfg8777999';
	...
	const NOTIFY_URL = 'http://github.com/xueyutianlang/qrcode/notify_url.php';
